# web.building_alias.py
from sqlalchemy import text
from db.db_supabase import get_session

# reuse the app's own table model if you copy it in, otherwise raw SQL is fine
# since this is a read + a simple insert, raw SQL avoids pulling in the ORM model
